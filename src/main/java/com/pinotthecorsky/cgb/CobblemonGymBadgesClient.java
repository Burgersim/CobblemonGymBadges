...
@EventBusSubscriber(modid = CobblemonGymBadges.MODID, value = Dist.CLIENT)
public class CobblemonGymBadgesClient {
    public CobblemonGymBadgesClient(ModContainer container) {
